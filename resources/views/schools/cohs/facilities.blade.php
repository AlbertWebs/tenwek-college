        ...
        <div class="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
            ...
            <header class="max-w-3xl" data-reveal>
                ...
                <h1 class="mt-4 font-serif text-4xl font-semibold tracking-tight text-thc-navy sm:text-5xl lg:text-[3.25rem]">
                    {{ $F['headline_before'] }}
                    <span class="italic text-thc-royal">{{ $F['headline_emphasis'] }}</span>
                </h1>
        ...
        <div class="mx-auto max-w-3xl lg:max-w-none">
            ...
            <ul class="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3" role="list" data-reveal>
                @foreach($F['highlights'] as $h)
                    <li class="flex h-full flex-col rounded-2xl border border-thc-navy/10 bg-white p-6 shadow-[var(--shadow-thc-card)] ring-1 ring-thc-navy/[0.04] transition hover:border-thc-royal/20 hover:shadow-[var(--shadow-thc-card-hover)] sm:p-8">
            ...
            <div class="mt-14 flex flex-wrap items-center justify-between gap-6 rounded-2xl border border-thc-navy/10 bg-gradient-to-br from-thc-royal/[0.06] to-white px-6 py-8 sm:px-10" data-reveal>
